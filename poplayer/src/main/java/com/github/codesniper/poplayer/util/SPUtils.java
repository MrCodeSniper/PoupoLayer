...
public class SPUtils {
    ...
    public static SPUtils getInstance(String spName,Context context) {
        ...
        if (sp == null) {
            sp = new SPUtils(spName,context);
            sSPMap.put(spName, sp);
        }
        return sp;
    }

    private SPUtils(String spName,Context context) {
    ...
    public void put( String key, int value) {
       boolean isPutSuccess=sp.edit().putInt(key, value).commit();
        Log.e("sputils","是否成功:"+isPutSuccess+"");
    }
